...
async function migrateData() {
    ...
    try {
        ...
        organizationIdMap[0] = defaultOrg.id;
        ...
        for (const oldComment of commentsResult.rows) {
            ...
            const newComment = await newDb.comment.create({
                data: {
                    ...
                    ticket_id: ticketIdMap[oldComment.ticket_id],
                    author_id: userIdMap[oldComment.author_id],
                },
            });
        ...
        for (const oldAttachment of attachmentsResult.rows) {
            ...
            const newAttachment = await newDb.attachment.create({
                data: {
                    ...
                    ticket_id: ticketIdMap[oldAttachment.ticket_id],
                    uploaded_by_id: userIdMap[oldAttachment.uploaded_by_id],
                },
            });
        ...
        for (const oldEvent of eventsResult.rows) {
            ...
            const newEvent = await newDb.ticketEvent.create({
                data: {
                    ...
                    ticket_id: ticketIdMap[oldEvent.ticket_id],
                    user_id: userIdMap[oldEvent.user_id],
                },
            });
