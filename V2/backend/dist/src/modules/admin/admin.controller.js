...
__decorate([
    (0, common_1.Get)('analytics/status-trend'),
    (0, swagger_1.ApiOperation)({ summary: 'Get ticket status trend over time' }),
    __param(0, (0, common_1.Query)('days')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], AdminController.prototype, "getStatusTrend", null);
