    ...
    async findOne(id) {
        try {
            ...
            if (error.code === 'P2003' || error.code === 'P2014') {
                throw new common_1.BadRequestException(`Database constraint error: ${error.meta?.field_name || 'unknown field'}`);
            }
            throw new common_1.BadRequestException(`Failed to fetch ticket: ${error.message || 'Unknown error'}`);
        }
    }
